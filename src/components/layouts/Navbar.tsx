...
const Navbar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    { id: 'home', name: 'Home', iconSrc: '/assets/img/igloo.png', href: '#' },
    { id: 'news', name: 'News', iconSrc: '/assets/img/nutrition.png', href: '#' },
    { id: 'recipe', name: 'Recipe', iconSrc: '/assets/img/recipe-book.png', href: '#' },
  ];
      ...
      >
        <div className="flex items-center justify-center space-x-2 px-4">
          {navItems.map((item) => (
            <div
              key={item.id}
              className={`nav-item relative cursor-pointer transition-all duration-300 ease-out ${
