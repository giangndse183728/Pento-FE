...
function PantrySection() {
  ...
  return (
    <div 
      ref={sectionRef} 
      className="min-h-screen w-screen flex-shrink-0 flex px-12 bg-blue-200/20">
         ...
         <div className="relative">
                ...
                >
                  ...
                  <p className="text-md text-black/60 leading-relaxed">
                    Keep track of everything in your pantry with ease. 
                    Scan items, check stock levels, and never run out of essentials.
                  </p>
                </StyledCard>
      </div>          
        </div>
