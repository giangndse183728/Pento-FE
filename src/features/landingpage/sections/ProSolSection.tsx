            ...
            <div className="space-y-6 relative">
              <div className="flex flex-col gap-4 mt-6 px-4">
                <div className="flex flex-row items-stretch justify-between gap-6 my-6">
                  <TextRevealParallax direction="up" delay={0} duration={700}>
                  ...
                  <TextRevealParallax direction="up" delay={150} duration={700}>
                ...
                <TextRevealParallax direction="right" delay={250} duration={700}>
                  <div className="flex justify-center mt-4">
                    <ReadonlyChat
                      placeholderNode={
                        <TextType
                          text={[
                            "Households throw away $1,500+ worth of food annually because they lose track of what's in their fridge. Food expires unnoticed, and you constantly buy duplicate items.",
                          ]}
                          typingSpeed={50}
                          pauseDuration={1500}
                          showCursor={true}
