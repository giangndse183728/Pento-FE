...
import "./PlanTicketCard.css";

interface PlaneTicketCardProps {
  from?: string;
  fromCode?: string;
  fromTime?: string;
  to?: string;
          ...
          <div className="content-data">
            <div className="destination">
              <div className="dest start">
                ...
                <p className="acronym">{fromCode}</p>
                <p className="hour">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="10"
              ...
              <div className="dest end">
                <p className="country">{to}</p>
                <p className="acronym">{toCode}</p>
                <p className="hour">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="10"
...
export default memo(PlaneTicketCard);
