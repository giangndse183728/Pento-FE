...
const DEFAULT_GLOW_COLOR = '185, 215, 234';
...
const cardData: BentoCardProps[] = [
  {
    ...
    label: 'Smart Alerts',
    backgroundImage: '/assets/img/expiry.png'
  },
  {
    color: '#060010',
  ...
  {
    color: '#060010',
    description: 'Cute, friendly, and gamified',
    label: 'Playful UI',
    backgroundImage: '/assets/img/play.png'
  },
  {
    color: '#060010',
    description: 'Track and organize',
    label: 'Dashboard',
    backgroundImage: '/assets/img/dashboard.png'
  }
  
];

const useLazyImage = (src: string, isVisible: boolean) => {
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const lazyImageSrc = useLazyImage(card.backgroundImage || '', isVisible);
          ...
          const cardProps = {
            ...
            style: {
              ...
              backgroundImage: lazyImageSrc ? `url(${lazyImageSrc})` : undefined,
