...
const InfiniteScroll: React.FC<InfiniteScrollProps> = ({
  ...
  useEffect(() => {
    ...
    const totalHeight = itemHeight * items.length + itemMarginTop * items.length;
  ...
  return (
    <>
      <style>
        {`
          :root {
            --gradient-start: ${ColorTheme.blueGray};
            --gradient-end: ${ColorTheme.darkBlue};
            --avatar-shadow: ${ColorTheme.blueGray}66;
          }
