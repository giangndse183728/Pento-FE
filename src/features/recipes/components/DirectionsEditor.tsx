                            ...
                            <div className="flex flex-row gap-4 items-start">
                                <div className="flex flex-col gap-4 flex-1">
                                    ...
                                    <div className="flex flex-row gap-2 items-start">
                                        ...
                                        <textarea
                                            className="neomorphic-textarea flex-1 overflow-hidden min-h-[90px]"
                                    ...
                                    <div className="flex flex-row gap-2 items-start">
                                        <label className="font-semibold w-24 pt-3" style={{ color: ColorTheme.darkBlue, fontSize: "1rem" }}>Image URL</label>
                                        <textarea
                                            className="neomorphic-textarea flex-1 overflow-hidden min-h-[90px]"
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="card" style={{ width: '300px', height: '280px', margin: '0' }}>
                                        <div className="tools">
                                        ...
                                        <div className="flex justify-center items-center mt-2 text-xs text-gray-500 italic">
                                            Step {d.stepNumber} Image
                                        </div>
                                    </div>
                                </div>
                            </div>
